  ...
  return (
    <>
      <div className="d-flex justify-content-between">
        <button type="button" className="btn btn-primary mb-2" onClick={prevPerson}>
          <GoChevronLeft />
        </button>
        <button type="button" className="btn btn-primary mb-2" onClick={randomPerson}>
          <GoSync />
        </button>
        <button type="button" className="btn btn-primary mb-2" onClick={nextPerson}>
          <GoChevronRight />
        </button>
      </div>
